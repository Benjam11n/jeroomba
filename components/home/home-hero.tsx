  ...
  return (
    <section className="grain overflow-hidden rounded-[2.5rem] border border-border/60 bg-card/85 px-6 py-8 shadow-[0_28px_120px_-60px_rgba(15,23,42,0.45)] sm:px-8 sm:py-10 lg:px-12 lg:py-12">
      <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(19rem,0.8fr)] lg:items-end">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-background/75 px-4 py-2 text-xs uppercase tracking-[0.25em] text-muted-foreground">
            <Sparkle className="size-3.5 text-accent" />
            Personal site starter
          </div>

          <h1 className="mt-6 max-w-4xl font-serif text-5xl leading-[0.96] text-balance sm:text-6xl lg:text-7xl">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-muted-foreground sm:text-lg">
            ...
            to the repo, and GSAP adds just enough movement to make the
            interface feel intentional.
          </p>

          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link href={ROUTES.blog} className={buttonVariants({ size: "lg" })}>
              Read the blog
